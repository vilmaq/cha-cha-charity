...
db.once("open", async () => {
  try {
    ...
    const userToEventMapper = {
      ...
      "info@battersea.org.uk": ["Placeholder Event"],
      "media@foe.co.uk": ["Placeholder Event"],
      "enquiries@nationaltrust.org.uk": ["Placeholder Event"],
      "enquiries@keepbritaintidy.org": ["Placeholder Event"],
      "office-ldn@london.msf.org": ["Placeholder Event"],
      "heretohelp@oxfam.org.uk": ["Placeholder Event"],
      "general@alzheimers.co.uk": ["Placeholder Event"],
      "news@acorns.org.uk": ["Placeholder Event"],
      "heretohelp@bhf.org.uk": ["Placeholder Event"],
      "info@emmausglasgow.org.uk": ["Placeholder Event"],
      "office@sifafireside.co.uk": ["Placeholder Event"],
      "info@theairambulanceservice.org.uk": ["Placeholder Event"],
      "admin@samaritans.org": ["Placeholder Event"],
      "info@mind.org.uk": ["Placeholder Event"],
      "supportercare@savethechildren.org.uk": ["Placeholder Event"],
      "interc@bdadyslexia.org.uk": ["Placeholder Event"],
      "hrhelpdesk@princes-trust.org.uk": ["Placeholder Event"],
      "info@artfund.com": ["Placeholder Event"],
      "admin@jewishmuseum.org.uk": ["Placeholder Event"],
      "info@shapearts.org.uk": ["Placeholder Event"],
